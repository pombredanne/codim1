/* Generated by Cython 0.20.1 on Thu Mar 20 20:40:35 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__codim1__fast__get_physical_points
#define __PYX_HAVE_API__codim1__fast__get_physical_points
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
#define __Pyx_MODULE_NAME "codim1.fast.get_physical_points"
int __pyx_module_is_main_codim1__fast__get_physical_points = 0;

/* Implementation of 'codim1.fast.get_physical_points' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_6codim1_4fast_19get_physical_points_get_physical_points(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_element_to_vertex, PyArrayObject *__pyx_v_vertices, int __pyx_v_element_id, double __pyx_v_reference_pt); /* proto */
...
static char __pyx_k_element_id[] = "element_id";
static char __pyx_k_RuntimeError[] = "RuntimeError";
static char __pyx_k_reference_pt[] = "reference_pt";
...
static PyObject *__pyx_n_s_reference_pt;
...
/* "codim1/fast/get_physical_points.pyx":6
 * cimport cython
 * 
...
static PyObject *__pyx_pw_6codim1_4fast_19get_physical_points_1get_physical_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_6codim1_4fast_19get_physical_points_get_physical_points(PyArrayObject *__pyx_v_element_to_vertex, PyArrayObject *__pyx_v_vertices, int __pyx_v_element_id, double __pyx_v_reference_pt, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_vertex1;
  int __pyx_v_vertex2;
  double __pyx_v_pt2_minus_pt1;
  double __pyx_v_pt1;
  PyArrayObject *__pyx_v_physical_pts = 0;
  int __pyx_v_d;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_element_to_vertex;
  __Pyx_Buffer __pyx_pybuffer_element_to_vertex;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_physical_pts;
  __Pyx_Buffer __pyx_pybuffer_physical_pts;
  ...
  __Pyx_RefNannySetupContext("get_physical_points", 0);
  __Pyx_TraceCall("get_physical_points", __pyx_f[0], 6);
  __pyx_pybuffer_physical_pts.pybuffer.buf = NULL;
  __pyx_pybuffer_physical_pts.refcount = 0;
  __pyx_pybuffernd_physical_pts.data = NULL;
  __pyx_pybuffernd_physical_pts.rcbuffer = &__pyx_pybuffer_physical_pts;
  ...
  __pyx_pybuffernd_vertices.rcbuffer = &__pyx_pybuffer_vertices;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_element_to_vertex.rcbuffer->pybuffer, (PyObject*)__pyx_v_element_to_vertex, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_vertices.rcbuffer->pybuffer, (PyObject*)__pyx_v_vertices, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "codim1/fast/get_physical_points.pyx":9
 *                           np.ndarray[double, ndim = 2] vertices,
 *                           int element_id, double reference_pt):
 ...
 */
  __pyx_t_1 = __pyx_v_element_id;
  __pyx_t_2 = 0;
  __pyx_t_3 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_pybuffernd_element_to_vertex.diminfo[0].shape;
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_pybuffernd_element_to_vertex.diminfo[0].shape)) __pyx_t_3 = 0;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_pybuffernd_element_to_vertex.diminfo[1].shape;
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 1;
  } else if (unlikely(__pyx_t_2 >= __pyx_pybuffernd_element_to_vertex.diminfo[1].shape)) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_v_vertex1 = (*__Pyx_BufPtrStrided2d(long *, __pyx_pybuffernd_element_to_vertex.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_element_to_vertex.diminfo[0].strides, __pyx_t_2, __pyx_pybuffernd_element_to_vertex.diminfo[1].strides));

  /* "codim1/fast/get_physical_points.pyx":10
 *                           int element_id, double reference_pt):
 *     cdef int vertex1 = element_to_vertex[element_id, 0]
 *     cdef int vertex2 = element_to_vertex[element_id, 1]             # <<<<<<<<<<<<<<
 *     cdef double pt2_minus_pt1, pt1
 ...
 */
  __pyx_t_3 = __pyx_v_element_id;
  __pyx_t_4 = 1;
  __pyx_t_5 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_pybuffernd_element_to_vertex.diminfo[0].shape;
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_pybuffernd_element_to_vertex.diminfo[0].shape)) __pyx_t_5 = 0;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_pybuffernd_element_to_vertex.diminfo[1].shape;
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 1;
  } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_element_to_vertex.diminfo[1].shape)) __pyx_t_5 = 1;
  if (unlikely(__pyx_t_5 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_5);
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_v_vertex2 = (*__Pyx_BufPtrStrided2d(long *, __pyx_pybuffernd_element_to_vertex.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_element_to_vertex.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_element_to_vertex.diminfo[1].strides));

  /* "codim1/fast/get_physical_points.pyx":12
 *     cdef int vertex2 = element_to_vertex[element_id, 1]
 *     cdef double pt2_minus_pt1, pt1
 *     cdef np.ndarray[double, ndim = 1] physical_pts = np.empty(2)             # <<<<<<<<<<<<<<
 *     cdef int d
 *     for d in range(2):
 */
  __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_empty); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_physical_pts.rcbuffer->pybuffer, (PyObject*)__pyx_t_8, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_physical_pts = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_physical_pts.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_physical_pts.diminfo[0].strides = __pyx_pybuffernd_physical_pts.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_physical_pts.diminfo[0].shape = __pyx_pybuffernd_physical_pts.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_8 = 0;
  __pyx_v_physical_pts = ((PyArrayObject *)__pyx_t_6);
  __pyx_t_6 = 0;

  /* "codim1/fast/get_physical_points.pyx":14
 *     cdef np.ndarray[double, ndim = 1] physical_pts = np.empty(2)
 *     cdef int d
 *     for d in range(2):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_5 = 0; __pyx_t_5 < 2; __pyx_t_5+=1) {
    ...
    /* "codim1/fast/get_physical_points.pyx":15
 *     cdef int d
 *     for d in range(2):
 *         pt1 = vertices[vertex1][d]             # <<<<<<<<<<<<<<
 *         pt2_minus_pt1 = vertices[vertex2][d] - pt1
 ...
 */
    __pyx_t_6 = __Pyx_GetItemInt(((PyObject *)__pyx_v_vertices), __pyx_v_vertex1, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_7 = __Pyx_GetItemInt(__pyx_t_6, __pyx_v_d, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_9 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_9 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_v_pt1 = __pyx_t_9;

    /* "codim1/fast/get_physical_points.pyx":16
 *     for d in range(2):
 *         pt1 = vertices[vertex1][d]
 *         pt2_minus_pt1 = vertices[vertex2][d] - pt1             # <<<<<<<<<<<<<<
 *         physical_pts[d] = pt1 + reference_pt * pt2_minus_pt1
 *     return physical_pts
 */
    __pyx_t_7 = __Pyx_GetItemInt(((PyObject *)__pyx_v_vertices), __pyx_v_vertex2, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_7 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_6 = __Pyx_GetItemInt(__pyx_t_7, __pyx_v_d, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_7 = PyFloat_FromDouble(__pyx_v_pt1); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_10 = PyNumber_Subtract(__pyx_t_6, __pyx_t_7); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_10);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __pyx_t_9 = __pyx_PyFloat_AsDouble(__pyx_t_10); if (unlikely((__pyx_t_9 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
    __pyx_v_pt2_minus_pt1 = __pyx_t_9;

    /* "codim1/fast/get_physical_points.pyx":17
 *         pt1 = vertices[vertex1][d]
 *         pt2_minus_pt1 = vertices[vertex2][d] - pt1
 *         physical_pts[d] = pt1 + reference_pt * pt2_minus_pt1             # <<<<<<<<<<<<<<
 *     return physical_pts
 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_pybuffernd_physical_pts.diminfo[0].shape;
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_physical_pts.diminfo[0].shape)) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
    *__Pyx_BufPtrStrided1d(double *, __pyx_pybuffernd_physical_pts.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_physical_pts.diminfo[0].strides) = (__pyx_v_pt1 + (__pyx_v_reference_pt * __pyx_v_pt2_minus_pt1));
  }

  /* "codim1/fast/get_physical_points.pyx":18
 *         pt2_minus_pt1 = vertices[vertex2][d] - pt1
 *         physical_pts[d] = pt1 + reference_pt * pt2_minus_pt1
 *     return physical_pts             # <<<<<<<<<<<<<<
 * 
 */
  ...
  __Pyx_INCREF(((PyObject *)__pyx_v_physical_pts));
  __pyx_r = ((PyObject *)__pyx_v_physical_pts);
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_physical_pts.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_vertices.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("codim1.fast.get_physical_points.get_physical_points", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_element_to_vertex.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_vertices.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_physical_pts);
...
/* Python wrapper */
static PyObject *__pyx_pw_6codim1_4fast_19get_physical_points_1get_physical_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_6codim1_4fast_19get_physical_points_1get_physical_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_element_to_vertex = 0;
  PyArrayObject *__pyx_v_vertices = 0;
  int __pyx_v_element_id;
  double __pyx_v_reference_pt;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_physical_points (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_element_to_vertex,&__pyx_n_s_vertices,&__pyx_n_s_element_id,&__pyx_n_s_reference_pt,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_element_to_vertex)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_vertices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_physical_points", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_element_id)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_physical_points", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_reference_pt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_physical_points", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_physical_points") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_element_to_vertex = ((PyArrayObject *)values[0]);
    __pyx_v_vertices = ((PyArrayObject *)values[1]);
    __pyx_v_element_id = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_element_id == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_reference_pt = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_reference_pt == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_physical_points", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("codim1.fast.get_physical_points.get_physical_points", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_element_to_vertex), __pyx_ptype_5numpy_ndarray, 1, "element_to_vertex", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_vertices), __pyx_ptype_5numpy_ndarray, 1, "vertices", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_6codim1_4fast_19get_physical_points_get_physical_points(__pyx_self, __pyx_v_element_to_vertex, __pyx_v_vertices, __pyx_v_element_id, __pyx_v_reference_pt);
...
static PyObject *__pyx_pf_6codim1_4fast_19get_physical_points_get_physical_points(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_element_to_vertex, PyArrayObject *__pyx_v_vertices, int __pyx_v_element_id, double __pyx_v_reference_pt) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_element_to_vertex;
  __Pyx_Buffer __pyx_pybuffer_element_to_vertex;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_vertices;
  __Pyx_Buffer __pyx_pybuffer_vertices;
  ...
  __pyx_pybuffernd_vertices.diminfo[0].strides = __pyx_pybuffernd_vertices.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_vertices.diminfo[0].shape = __pyx_pybuffernd_vertices.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_vertices.diminfo[1].strides = __pyx_pybuffernd_vertices.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_vertices.diminfo[1].shape = __pyx_pybuffernd_vertices.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_6codim1_4fast_19get_physical_points_get_physical_points(((PyArrayObject *)__pyx_v_element_to_vertex), ((PyArrayObject *)__pyx_v_vertices), __pyx_v_element_id, __pyx_v_reference_pt, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("get_physical_points"), (PyCFunction)__pyx_pw_6codim1_4fast_19get_physical_points_1get_physical_points, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("get_physical_points"),
    0, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_reference_pt, __pyx_k_reference_pt, sizeof(__pyx_k_reference_pt), 0, 0, 1, 1},
 ...
 *     for d in range(2):
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_int_2); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initget_physical_points(void); /*proto*/
PyMODINIT_FUNC initget_physical_points(void)
#else
PyMODINIT_FUNC PyInit_get_physical_points(void); /*proto*/
PyMODINIT_FUNC PyInit_get_physical_points(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_get_physical_points(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("get_physical_points"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_codim1__fast__get_physical_points) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "codim1.fast.get_physical_points")) {
      if (unlikely(PyDict_SetItemString(modules, "codim1.fast.get_physical_points", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("get_physical_points", (void (*)(void))__pyx_f_6codim1_4fast_19get_physical_points_get_physical_points, "PyObject *(PyArrayObject *, PyArrayObject *, int, double, int __pyx_skip_dispatch)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  ...
  /* "codim1/fast/get_physical_points.pyx":2
 * # cython: profile=True
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * cimport cython
 */
  ...
  /* "codim1/fast/get_physical_points.pyx":1
 * # cython: profile=True             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init codim1.fast.get_physical_points", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init codim1.fast.get_physical_points");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
